...
import { mapJobDisputeNotificationEvent } from "./job-dispute.js";
...
export function mapDemandSideNotificationEvent(
  ...
  const alpha = mapAlphaNotificationEvent(event);
  const dispute = mapJobDisputeNotificationEvent(event);
